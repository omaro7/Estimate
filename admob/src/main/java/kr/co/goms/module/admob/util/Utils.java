package kr.co.goms.module.admob.util;
...
public class Utils
{
	...
	public static String encrypt(String value, String iv, String key)
	{
		...
		try
		{
			returnValue = URLEncoder.encode(AES_Encode(value, iv, key), "UTF-8");
		}
		catch (Exception e)
		{
			returnValue = "";
	...
	public static String encrypt2(String value, String iv, String key)
	{
		...
		try
		{
			returnValue = AES_Encode(value, iv, key);
		}
		catch (Exception e)
		{
			returnValue = "";
	...
	public static String decrypt(String value, String iv, String key)
	{
		...
		try
		{
			returnValue = AES_Decode(URLDecoder.decode(value, "UTF-8"), iv, key);
		}
		catch (Exception e)
		{
			returnValue = "";
	...
	public static String decrypt2(String value, String iv, String key)
	{
		...
		try
		{
			returnValue = AES_Decode(value, iv, key);
		}
		catch (Exception e)
		{
			returnValue = "";
