 ...
 * 아이템 삭제하기
 */
public class ItemDeleteData extends LocalData implements ISendData{
    private final String TAG = ItemDeleteData.class.getSimpleName();
    @Override
    public void onSendData() {
        GomsLog.d(TAG, ItemDeleteData.class.getSimpleName() + " >>>> ItemList Data()");
