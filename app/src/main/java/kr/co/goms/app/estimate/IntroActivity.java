...
import kr.co.goms.app.estimate.activity.BaseActivity;
import kr.co.goms.app.estimate.process.IntroProcess;
...
public class IntroActivity extends BaseActivity {
    ...
    protected void introProcessLoadComplete() {
        ...
        GomsLog.d(TAG, "introProcessLoadComplete() : adId : " + adId);
        ...
        MyApplication.getInstance().prefs().put(EstimatePrefs.IS_FIRST_TIME_EXECUTE_THE_APP, true);
    }
