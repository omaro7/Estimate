package kr.co.goms.app.estimate.common;
...
public class EstimatePrefs {
	...
	private static EstimatePrefs mEstimatePrefs = null;					//인스턴스
	private SharedPreferences  mPrefs;												//SharedPreferences

	private EstimatePrefs(Context context) {
	 ...
	 * @return
	 */
	public static EstimatePrefs getInstance(Context context) {
		if (mEstimatePrefs == null)
			mEstimatePrefs = new EstimatePrefs(context);
		return mEstimatePrefs;
	}
	 ...
	 * @return
	 */
	public static EstimatePrefs getInstance() {
		return mEstimatePrefs;
	}
	...
	public boolean putKey(String pValue) {
		return mPrefs.edit().putString(EstimatePrefs.S_KEY, pValue).commit();
	}
	public String getKey(){
		return mPrefs.getString(EstimatePrefs.S_KEY, EMPTY);
	}
