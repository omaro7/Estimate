 ...
 * 견적서 삭제하기
 */
public class EstDeleteData extends LocalData implements ISendData{
    private final String TAG = EstDeleteData.class.getSimpleName();
    @Override
    public void onSendData() {
        GomsLog.d(TAG, EstDeleteData.class.getSimpleName() + " >>>> EstimateList Data()");
        ...
        ArrayList<EstimateBeanTB> estimateList = MyApplication.getInstance().getDBHelper().deleteEstimateData(estIdx);
        successData(estimateList);
