...
public class CommandErrorCode404 extends Command {
    ...
    protected BaseBean onCommand(Activity activity, Object object, BaseBean baseData) throws Exception {
        DialogManager.I().setTitle("에러")
                .setMessage(((CommonBean)baseData.getObject()).getRmsg())
                .setShowTitle(false)
                .setShowMessage(true)
                .setNegativeBtnName("")
                ...
                .setCommand(DialogCommandFactory.I().createDialogCommand(activity, DialogCommandFactory.DIALOG_TYPE.permission.name(), new WaterCallBack() {
                    @Override
