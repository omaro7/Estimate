...
public class BottomDialogInputForm {
    ...
    protected EditText mEtInput = null;
    ...
    public BottomDialogInputForm(Activity activity, Object object){
    ...
    protected void onCreate(Activity activity, String title, String message) {
        ...
        dialog.setContentView(R.layout.bottom_popup_input_form);
            ...
            public void onClick(View v) {
                ...
                if(id == R.id.ok_bt2 || id == R.id.ok_bt1){
                    ...
                    if(StringUtil.isEmpty(inputData)){
                        CurvletManager.process(activity, null, "water://toast?text=내용을 입력해주세요");
                        return;
                    }

                    if("groupInsert".equalsIgnoreCase(tagString)) {
                        if (isExistGroupName(inputData)) {
                            CurvletManager.process(activity, null, "water://toast?text=다른 그룹명을 입력해주세요");
                            return;
                        }
                    }
