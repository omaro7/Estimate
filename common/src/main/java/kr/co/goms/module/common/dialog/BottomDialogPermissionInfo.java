...
public class BottomDialogPermissionInfo {
    ...
    public BottomDialogPermissionInfo(Activity activity, int title, int messageId) {
        this.activity = activity;
        titleString = activity.getString(title);
        messageString = activity.getString(messageId);
    }

    public BottomDialogPermissionInfo(Activity activity, String title, String message) {
        this.activity = activity;
        titleString = title;
     ...
     */
    public BottomDialogPermissionInfo(Activity activity, String title, String message, boolean _isShowTitle) {
        this.activity = activity;
        titleString = title;
        messageString = message;
     ...
     */
    public BottomDialogPermissionInfo(Activity activity, String title, String message, boolean _isShowTitle, boolean _isCancelable, boolean _isCancelTouchOutSide) {
        this.activity = activity;
        titleString = title;
        messageString = message;
        isShowTitle = _isShowTitle;
    ...
    protected void onCreate(Activity activity, String title, String message) {
        ...
        dialog.setContentView(R.layout.bottom_popup_permission_info);
