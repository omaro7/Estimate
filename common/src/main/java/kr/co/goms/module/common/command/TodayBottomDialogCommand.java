...
import kr.co.goms.module.common.dialog.BottomDialogToday;
 ...
 */
public class TodayBottomDialogCommand extends Command {

    private final String TAG = TodayBottomDialogCommand.class.getSimpleName();
    private Activity mActivity;
    private WaterCallBack mCommandCallBack;
    private static String mDialogCode = "0000";
    private static int mDialogResourceId;

    private static TodayBottomDialogCommand mBaseDialogCommand;
    ...
    //생성자
    public TodayBottomDialogCommand(){

    }

    //싱클톤
    public static TodayBottomDialogCommand getInstance(){
        if(mBaseDialogCommand == null){
            mBaseDialogCommand = new TodayBottomDialogCommand();
        }
        return mBaseDialogCommand;
    }


    public TodayBottomDialogCommand setBaseDialogCommand(Activity activity, String dialogCode, int resourceId, WaterCallBack commandCallback){
        mActivity = activity;
    ...
    private void goBaseDialog(Activity activity, Object object, BaseBean baseData){
        ...
        final BottomDialogToday baseBottomDialog = new BottomDialogToday(activity, object);
